(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/cdk/coercion'), require('rxjs/operators'), require('@angular/forms'), require('@angular/common'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('@angular/material'), require('@angular/cdk/scrolling')) :
	typeof define === 'function' && define.amd ? define('material-community-components', ['exports', '@angular/core', 'rxjs', '@angular/cdk/coercion', 'rxjs/operators', '@angular/forms', '@angular/common', '@angular/cdk/overlay', '@angular/cdk/portal', '@angular/material', '@angular/cdk/scrolling'], factory) :
	(factory((global['material-community-components'] = {}),global.ng.core,global.rxjs,global.ng.cdk.coercion,global.Rx.Observable.prototype,global.ng.forms,global.ng.common,global.ng.cdk.overlay,global.ng.cdk.portal,global.ng.material,global.ng.cdk.scrolling));
}(this, (function (exports,core,rxjs,coercion,operators,forms,common,overlay,portal,material,scrolling) { 'use strict';
...
MccColorPickerService.ctorParameters = function () { return [
    { type: undefined, decorators: [{ type: core.Inject, args: [EMPTY_COLOR,] },] },
]; };
...
MccColorPickerComponent.propDecorators = {
    "_collections": [{ type: core.ContentChildren, args: [MccColorPickerCollectionComponent,] },],
    "usedColorLabel": [{ type: core.Input },],
    "usedColorStart": [{ type: core.Input },],
    "reverseUsedColors": [{ type: core.Input },],
    "hideHexForms": [{ type: core.Input, args: ['hideHexForms',] },],
    "hideEmpty": [{ type: core.Input, args: ['hideEmptyUsedColors',] },],
    "hideTransparent": [{ type: core.Input, args: ['hideTransparentUsedColors',] },],
    ...
    "colorPickerSelectorHeight": [{ type: core.Input },],
    "hideColorPickerSelector": [{ type: core.Input },],
...
var MccColorPickerSelectorComponent = /** @class */ (function () {
    ...
    MccColorPickerSelectorComponent.prototype.ngOnInit = function () {
        ...
        this.rgbKeys.forEach(function (key, index) { return (rgbGroup[key] = new forms.FormControl(rgbValue[index], {
            validators: [
...
MccColorPickerOptionDirective.propDecorators = {
    "color": [{ type: core.Input, args: ['mccColorPickerOption',] },],
};
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return MccColorPickerOriginDirective; }),
                        multi: true,
                    },
                ],
            },] },
...
MccConnectedColorPickerDirective.propDecorators = {
    "origin": [{ type: core.Input, args: ['mccConnectedColorPickerOrigin',] },],
};
...
MccTimerPickerComponent.propDecorators = {
    "hideButtons": [{ type: core.Input },],
    "format": [{ type: core.Input, args: ['mccTimerPickerFormat',] },],
    "btnCancel": [{ type: core.Input },],
    "btnConfirm": [{ type: core.Input },],
    "selected": [{ type: core.Output },],
};
...
MccTimerPickerOriginDirective.decorators = [
    { type: core.Directive, args: [{
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return MccTimerPickerOriginDirective; }),
                        multi: true,
                    },
                ],
            },] },
...
MccConnectedTimerPickerDirective.propDecorators = {
    "origin": [{ type: core.Input, args: ['mccConnectedTimerPickerOrigin',] },],
};
...
MccScrollspyItemDirective.propDecorators = {
    "focus": [{ type: core.Input, args: ['focus',] },],
    "label": [{ type: core.Input },],
};
...
MccScrollspyGroupDirective.propDecorators = {
    "items": [{ type: core.ContentChildren, args: [MccScrollspyItemDirective,] },],
    "name": [{ type: core.Input, args: ['mccScrollspyGroup',] },],
};
var ɵ0 = window;
...
exports.ɵc = MccColorPickerCollectionComponent;
exports.ɵg = MccColorPickerSelectorComponent;
exports.ɵb = MccColorPickerComponent;
exports.ɵd = MccColorPickerOptionDirective;
exports.ɵe = MccColorPickerOriginDirective;
exports.ɵf = MccConnectedColorPickerDirective;
exports.ɵa = MccScrollspyGroupDirective;
exports.ɵh = MccTimerPickerComponent;
exports.ɵj = MccConnectedTimerPickerDirective;
exports.ɵi = MccTimerPickerOriginDirective;
